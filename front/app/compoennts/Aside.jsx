...
export default function Aside({ active, setActive }) {
  ...
  return (
    <aside className="bg-white fixed left-0 top-0 min-h-screen w-64 border-r flex flex-col items-start justify-between py-6 px-4">
      <div>
      ...
      <div className="px-4 flex items-start flex-col gap-3 py-8">
        ...
        <button onClick={Logout} className="flex items-center  gap-2 w-full text-red-500 py-2 hover:bg-red-50 rounded-lg transition">
